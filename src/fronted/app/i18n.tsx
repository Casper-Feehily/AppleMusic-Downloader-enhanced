...
const zh: Record<string, string> = {
  ...
  "download.wrapper_not_ready": "Wrapper 未连接、未登录或解密服务未就绪",
  ...
  "settings.wrapper_unreachable": "无法连接本机 Wrapper",
...
const en: Record<string, string> = {
  ...
  "download.wrapper_not_ready": "Wrapper is disconnected, logged out, or not ready for playback",
  ...
  "settings.wrapper_unreachable": "Local Wrapper is unreachable",
  "settings.apple_id": "Apple ID",
